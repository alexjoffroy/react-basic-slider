...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactBasicSlider = __webpack_require__(166);

	var _reactBasicSlider2 = _interopRequireDefault(_reactBasicSlider);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { key: '1', className: 'Slider__Slide--1' },
	          'Slide1'
	        ),
	        _react2.default.createElement(
	          'div',
	          { key: '2', className: 'Slider__Slide--2' },
	          'Slide2'
	        ),
	        _react2.default.createElement(
	          'div',
	          { key: '3', className: 'Slider__Slide--3' },
	          'Slide3'
	        )
	      ),
	      _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (e, t) {
		"object" == ( false ? "undefined" : _typeof(exports)) && "object" == ( false ? "undefined" : _typeof(module)) ? module.exports = t(__webpack_require__(1), __webpack_require__(168)) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(168)], __WEBPACK_AMD_DEFINE_FACTORY__ = (t), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports["react-basic-slider"] = t(require("react"), require("react-addons-css-transition-group")) : e["react-basic-slider"] = t(e.react, e["react-addons-css-transition-group"]);
		...
		return function (e) {
			...
			function n(e) {
				...
				return (0, c.default)("Slider", "Slider--" + e, t);
			}function o(e, t) {
				return u.default.Children.map(t, function (t, r) {
					return e === r ? u.default.cloneElement(t, { className: (0, c.default)("Slider__Slide", t.props.className) }) : null;
				});
			    ...
			    c = n(p),
			    l = r(3),
			    d = n(l);r(4), t.default = u.default.createClass({ displayName: "Slider", propTypes: { className: u.default.PropTypes.string, currentIndex: u.default.PropTypes.number, interval: u.default.PropTypes.number, onSlideChange: u.default.PropTypes.func, style: u.default.PropTypes.object, transitionDuration: u.default.PropTypes.number }, getDefaultProps: function getDefaultProps() {
					return { currentIndex: 0, interval: 0, transitionDuration: 0 };
				}, getInitialState: function getInitialState() {
					return { currentIndex: this.props.currentIndex, direction: "next" };
				}, componentDidMount: function componentDidMount() {
					this.props.interval > 0 && setInterval(this.next, this.props.interval);
				}, render: function render() {
					var e = { enter: "Slider__Slide--enter", leave: "Slider__Slide--leave" };return u.default.createElement(d.default, s({}, this.props, { component: "div", transitionName: e, transitionEnterTimeout: this.props.transitionDuration, transitionLeaveTimeout: this.props.transitionDuration, className: i(this.state.direction, this.props.className) }), o(this.state.currentIndex, this.props.children));
				}, goTo: function goTo(e) {
					var t = e > this.state.currentIndex ? "next" : "previous";return e = e < this.props.children.length ? e : 0, e = e >= 0 ? e : this.props.children.length - 1, this.setState({ currentIndex: e, direction: t }), this.props.onSlideChange ? this.props.onSlideChange(e) : void 0;
				}, next: function next() {
				...
				function r() {
					for (var e = [], t = 0; t < arguments.length; t++) {
						var n = arguments[t];if (n) {
							var i = typeof n === "undefined" ? "undefined" : _typeof(n);if ("string" === i || "number" === i) e.push(n);else if (Array.isArray(n)) e.push(r.apply(null, n));else if ("object" === i) for (var s in n) {
								o.call(n, s) && n[s] && e.push(s);
							}
						}
					}return e.join(" ");
				}var o = {}.hasOwnProperty;"undefined" != typeof e && e.exports ? e.exports = r : (n = [], i = function () {
					return r;
	...
	//# sourceMappingURL=react-basic-slider.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box; }\n\n.App {\n  margin: auto;\n  max-width: 50rem;\n  height: 100vh; }\n\n.Slider {\n  height: 400px; }\n\n.Slider__Slide {\n  border: 1px solid black;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-justify-content: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center; }\n\n.Slider--1.Slider--previous .Slider__Slide--enter {\n  right: -100%; }\n\n.Slider--1.Slider--previous .Slider__Slide--enter-active {\n  right: 0;\n  transition: right 500ms ease-in; }\n\n.Slider--1.Slider--previous .Slider__Slide--leave {\n  right: 0; }\n\n.Slider--1.Slider--previous .Slider__Slide--leave-active {\n  right: 100%;\n  transition: right 500ms ease-in; }\n\n.Slider--1.Slider--next .Slider__Slide--enter {\n  left: -100%; }\n\n.Slider--1.Slider--next .Slider__Slide--enter-active {\n  left: 0;\n  transition: left 500ms ease-in; }\n\n.Slider--1.Slider--next .Slider__Slide--leave {\n  left: 0; }\n\n.Slider--1.Slider--next .Slider__Slide--leave-active {\n  left: 100%;\n  transition: left 500ms ease-in; }\n\n.Slider--2.Slider--previous .Slider__Slide--enter {\n  bottom: -100%; }\n\n.Slider--2.Slider--previous .Slider__Slide--enter-active {\n  bottom: 0;\n  transition: bottom 500ms ease-in; }\n\n.Slider--2.Slider--previous .Slider__Slide--leave {\n  bottom: 0; }\n\n.Slider--2.Slider--previous .Slider__Slide--leave-active {\n  bottom: 100%;\n  transition: bottom 500ms ease-in; }\n\n.Slider--2.Slider--next .Slider__Slide--enter {\n  top: -100%; }\n\n.Slider--2.Slider--next .Slider__Slide--enter-active {\n  top: 0;\n  transition: top 500ms ease-in; }\n\n.Slider--2.Slider--next .Slider__Slide--leave {\n  top: 0; }\n\n.Slider--2.Slider--next .Slider__Slide--leave-active {\n  top: 100%;\n  transition: top 500ms ease-in; }\n", ""]);
